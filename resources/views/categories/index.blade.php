    ...
    <table class="w-full">
        ...
        <tr class="text-center">
            ...
            <th class="p-2 border border-grey-50">
                <a href="{{route('categories.edit',$category->order)}}" class="bg-blue-500 text-white px-2 py-1 rounded-md">Edit</a>
                <a href="{{route('categories.destroy',$category->order)}}"  class="bg-red-500 text-white px-2 py-1 rounded-md">Delete</a>
            </th>
        </tr>
        @endforeach
    </table>
